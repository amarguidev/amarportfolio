...
------------------------------------------------------*/
    ...
    // main directions
       map = new GMaps({
        el: '#map', lat: 41.553269, lng: -93.759758, zoom: 15, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 41.553269, lng: -93.759758, title: 'My Residence',
      infoWindow: { content: '<p>1155 Office Park Rd, APT # 306, West Des Moines, Iowa, 50265</p>' } });
